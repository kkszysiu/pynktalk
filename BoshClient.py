...
from twisted.internet import defer, protocol, reactor, stdio, error
from twisted.python import log, reflect
from twisted.words.xish import domish, utility
from twisted.web import http
from twisted.words.protocols.jabber import xmlstream, client, jid
from twisted.protocols import basic
import random, binascii, base64, hashlib, time, os, random, sys, urlparse
...
class Keys(object):
    ...
    def set_keys(self):
        ...
        for i in range(self.num_keys-1):
            x = i + 1
            self.k.append(hashlib.sha1(str(self.k[x-1])).hexdigest())
...
class HTTPBClientConnector(object):
    """
